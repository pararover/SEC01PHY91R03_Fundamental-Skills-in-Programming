	...
	\subsection{Numerical data}
		...
		\begin{table}[!htb]
			...
			\begin{tabular}{lll}
				...
				\midrule[1.2pt]
				\texttt{int8} & {Signed 8-bit integer} & {$\qty[-2^7,2^7-1]$} \\ \hline
				\texttt{uint8} & {Unsigned 8-bit integer} & {$\qty[0,2^8-1]$} \\ \hline
				\texttt{int16} & {Signed 16-bit integer} & {$\qty[-2^{15},2^{15}-1]$} \\ \hline
				\texttt{uint16} & {Unsigned 16-bit integer} & {$\qty[0,2^{16}-1]$} \\ \hline
				\texttt{int32} & {Signed 32-bit integer} & {$\qty[-2^{31},2^{31}-1]$} \\ \hline
				\texttt{uint32} & {Unsigned 32-bit integer} & {$\qty[0,2^{32}-1]$} \\ \hline
				\texttt{int64} & {Signed 64-bit integer} & {$\qty[-2^{63},2^{63}-1]$} \\ \hline
